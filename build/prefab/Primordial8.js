(function (factory) {
    ...
    exports.List = [
        ...
        new trigram_1.default([Base_1.YAO.YANG, Base_1.YAO.YANG, Base_1.YAO.YIN]),
    ...
    exports.Matrix = [
        [exports.List[1], exports.List[0], exports.List[4]],
        [exports.List[2], null, exports.List[5]],
        [exports.List[3], exports.List[7], exports.List[6]]
    ];
});
//# sourceMappingURL=primordial8.js.map